...
def print_shell(name,bg):
  ...
  print '# %s_%s scheme by haystackandroid (https://github.com/haystackandroid/snow)' % (name, bg)
  print ''
...
def print_fish(name,bg):
  ...
  print '# %s_%s fish shell theme by haystackandroid (https://github.com/haystackandroid/snow)' % (name, bg)
  print ''
  print '# normal text'
